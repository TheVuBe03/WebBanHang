...
if (isset($_GET['act'])) {
    ...
    switch ($act) {
        ...
        case 'update_kh':
            ...
            break;
        case 'tk':
                $sql = "select l.ma_loai as ml ,l.ten_loai as tl, count(l.ma_loai) as sl, min(h.don_gia) as min, max(h.don_gia) as max, avg(h.don_gia) as tb  from hang_hoa h join loai l on h.ma_loai= l.ma_loai group by l.ma_loai ";
                $tk = pdo_query($sql);
